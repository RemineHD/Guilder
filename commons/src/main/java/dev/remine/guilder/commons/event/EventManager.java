package dev.remine.guilder.commons.event;

import dev.remine.guilder.commons.event.events.Event;
import dev.remine.guilder.commons.event.events.Scoped;
import dev.remine.guilder.commons.event.events.Typed;
import dev.remine.guilder.commons.event.exceptions.ErrorPolicy;
import dev.remine.guilder.commons.event.exceptions.EventDispatchException;
import dev.remine.guilder.commons.event.listeners.EventHandler;
import dev.remine.guilder.commons.event.listeners.EventType;
import dev.remine.guilder.commons.event.listeners.ListenerPriority;
import dev.remine.guilder.commons.event.listeners.ListenerScope;
import dev.remine.guilder.commons.event.scope.ScopeGroup;
...
public final class EventManager {
    ...
    /**
     * Identify and registers all {@link dev.remine.guilder.commons.event.listeners.EventHandler} methods in the class of given Object instance. The
    ...
    private static class Listener {
        ...
        /**
         * Create a container for listener methods with all necessary metadata
         *
